				...
				<div className="wid-content">
					...
					<div className="content">
						...
						<div class="flex flex-wrap justify-center gap-2 mt-9">
							<div class="relative grid text-2xl rounded-full shadow-md bg-bg-secondary dark:shadow-xl h-14 w-14 sm:h-16 sm:w-16 place-items-center group">
								<svg
								...
								<div class="absolute invisible px-2 py-1 text-sm text-white capitalize duration-200 rounded opacity-0 w-max group-hover:opacity-100 group-hover:visible -top-8 bg-slate-900/75 dark:bg-slate-700/90 dark:text-slate-100">
									html-5
									<svg
										class="absolute left-0 w-full h-2 text-slate-900/75 dark:text-slate-700/90 top-full"
										x="0px"
										y="0px"
										viewBox="0 0 255 255"
									>
						...
						<ul className="wid-list-container">
							<li className="wid-list">
								Building responsive static websites using vanilla JS
							</li>
							<li className="wid-list">
